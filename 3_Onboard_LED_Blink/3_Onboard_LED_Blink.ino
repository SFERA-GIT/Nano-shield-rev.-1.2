...
//Тело функции loop
{
 ...
 delay(1000);            //Ожидание 1000 (1 секунда) милисекунд после включения светодиодов (5,6,7,8)
 ...
 digitalWrite(green,0);  //выключение контакта green(8)

 delay(1000);            //Ожидание 1000 милисекунд (1 секунда) после выключения светодиодов (5,6,7,8)
// Результат работы программы мигание 4 светодиодов на плате с интервалом в 1 секунду.
}
